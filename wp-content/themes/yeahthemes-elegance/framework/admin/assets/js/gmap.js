( function( $ )
{
	...
	mapField.prototype = {
		...
		{
			this.canvas = this.$container.find( '.yt-map-canvas' )[0];
			this.$coordinate = this.$container.find( '.yt-map-coordinate' );
			this.$findButton = this.$container.find( '.yt-map-goto-address' );
